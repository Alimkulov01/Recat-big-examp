...
import Carusel from '../container/CaruselHeader/CaruselHeader'
...
const Home = () => {
	...
	return (
		...
		<div className="home">
			...
			<main className="home-center container">
				<div className="home-center-top">
					<Link to="/" className="home-center-top__link active">
						Новые объявления
					</Link>
					<Link to="/Лучщие-предложение" className="home-center-top__link">
						Лучщие предложение
					</Link>
				</div>


				<div className="home-center-cards">
					{
